...
exports.register = async (req, res, next) => {
  try {
    const { email, password, userType, profile, organization } = req.body;
    ...
    // Add profile or organization data based on user type
    if (userType === 'citizen' && profile) {
      userData.profile = profile;
    } else if (userType === 'organization' && organization) {
